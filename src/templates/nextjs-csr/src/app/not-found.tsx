  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 px-4">
      ...
      >
        ...
        <motion.h1
          className="text-6xl font-bold text-gray-800 mb-2 text-center select-none"
          initial={{ y: -20 }}
          animate={{ y: 0 }}
          transition={springConfig}
        >
        ...
        <motion.p
          className="text-xl text-gray-600 text-center mb-8 select-none"
          initial={{ y: 20 }}
          animate={{ y: 0 }}
      ...
      >
        <Link href="/">
          <motion.button
            className="px-6 py-3 select-none bg-primary text-white rounded-full font-semibold text-lg shadow-lg"
